...
if (window.location.href.split("/")[3] == "admin") {
  __webpack_require__(/*! ./sweetalert.js */ "./resources/js/sweetalert.js");
}
...
var urlSplit = geUrl.split("/");
var flashMessage = document.getElementById("flash-message");
var flashMessageData = flashMessage.getAttribute("data-message");
if (flashMessageData) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                selectedRow = document.querySelector("tr.data-table");
                sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
                  title: "Are you sure?",
                        ...
                        switch (_context.prev = _context.next) {
                          case 0:
                            if (result.isConfirmed) {
                              httpSending = "/admin/properties-gallery/".concat(deleteId);
                              submitData(httpSending, "delete");
                              selectedRow.remove();
                              sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire("Deleted!", "Your data has been deleted.", "success");
                            }
                          case 1:
                          case "end":
...
if (urlSplit[4].split("?")[0] == "properties-villa") {
  ...
  _btnDelete.forEach(function (btn) {
    btn.onclick = function (event) {
      event.preventDefault();
      var slug = btn.getAttribute("data-slug");
      var selectedRow = document.querySelector("tr[data-slug=".concat(slug, "]"));
      sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
        title: "Are you sure?",
        text: "Are you want to delete this data ? ",
        icon: "warning",
        ...
        if (result.isConfirmed) {
          var httpSending = "/admin/properties-villa/".concat(slug);
          submitData(httpSending, "delete");
          sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire("Deleted!", "Your data has been deleted.", "success");
          selectedRow.remove();
        }
...
if (urlSplit[4].split("?")[0] == "properties-feature") {
  ...
  _btnDelete2.forEach(function (btn) {
    btn.onclick = function (event) {
      event.preventDefault();
      var id = btn.getAttribute("data-id");
      var selectedRow = document.querySelector("tr.data-table");
      sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
        title: "Are you sure?",
        text: "Are you want to delete this data ? ",
        icon: "warning",
        ...
        if (result.isConfirmed) {
          var httpSending = "/admin/properties-feature/".concat(id);
          submitData(httpSending, "delete");
          sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire("Deleted!", "Your data has been deleted.", "success");
          selectedRow.remove();
        }
  ...
  btnDelete.forEach(function (btn) {
    btn.onclick = function (event) {
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
        ...
        if (result.isConfirmed) {
          var httpSending = "/admin/categories-property/".concat(slug);
          submitData(httpSending, "delete");
          sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire("Deleted!", "Your data has been deleted.", "success");
          selectedRow.remove();
        }
...
var submitData = /*#__PURE__*/function () {
  ...
  return function submitData(_x3, _x4) {
